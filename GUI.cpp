...
int main(int argc, char *argv[]) {
    ...
    gridLayout->addWidget(startButton2, 2, 0, 1, 4);
    ...
    gridLayout->addWidget(trackOneButton, 3, 0, 1, 2);
    gridLayout->addWidget(trackTwoButton, 3, 2, 1, 2);

    // Working time display
    QLabel *workingTimeLabel = new QLabel("12:30\nWorking Time");
    workingTimeLabel->setStyleSheet(labelStyle);
    gridLayout->addWidget(workingTimeLabel, 4, 0, 1, 2);

    // Laps display
    QLabel *lapsLabel = new QLabel("003\nLaps");
    lapsLabel->setStyleSheet(labelStyle);
    gridLayout->addWidget(lapsLabel, 4, 2, 1, 2);
    ...
    gridLayout->addWidget(lightButton, 5, 0, 1, 2);
    gridLayout->addWidget(moreSettingsButton, 5, 2, 1, 2);
